...
function getHistory() {
    ...
    locHis.reverse().map((cities) => {
        // (;-_-)
        $("#history").append(`<li id="hisBtn" type="button" class="btn btn-primary btn-lg btn-block d-block my-2" style="height: 60px" onClick="searchPrep(this.textContent)">${cities}</li>`)
    })
}
...
function searchPrep(searchData) {
    ...
    let queryDay = "http://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=" + key +"&units=imperial";
    fetch(queryDay)
    .then((response) => {
        response.json()
        .then((data1) => {
    ...
    <div class="card border border-primary">
        <div class=" p-2 bg-info">
            <h1 class="text-light">${sameDay.name} (${month + 1}/${day}/${year}) </h1>
            <img src="${'https://openweathermap.org/img/wn/' + sameDay.weather[0].icon + '@2x.png'}"/>
            ...
            <div class="col-2 p-1">
                <div class="card text-center border border-primary">
                    <div class="bg-info">
                        ...
                        <img src="${'https://openweathermap.org/img/wn/' + data.list[4].weather[0].icon + '@2x.png'}"/>
            ...
            <div class="col-2 p-1">
                <div class="card text-center border border-primary">
                    <div class="bg-info">
                        ...
                        <img src="${'https://openweathermap.org/img/wn/' + data.list[12].weather[0].icon + '@2x.png'}"/>
            ...
            <div class="col-2 p-1">
                <div class="card text-center border border-primary">
                    <div class="bg-info">
                        ...
                        <img src="${'https://openweathermap.org/img/wn/' + data.list[20].weather[0].icon + '@2x.png'}"/>
            ...
            <div class="col-2 p-1">
                <div class="card text-center border border-primary">
                    <div class="bg-info">
                        ...
                        <img src="${'https://openweathermap.org/img/wn/' + data.list[28].weather[0].icon + '@2x.png'}"/>
            ...
            <div class="col-2 p-1">
                <div class="card text-center border border-primary">
                    <div class="bg-info">
                        ...
                        <img src="${'https://openweathermap.org/img/wn/' + data.list[36].weather[0].icon + '@2x.png'}"/>
